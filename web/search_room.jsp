<%-- 
    Document   : searh_room
    Created on : Apr 3, 2020, 9:40:01 AM
    Author     : Rajkumar
--%>
                 ...
                 <div class="card" style="width: 34rem">
                     ...
                     <div class="card-block  btn-primary">
                         ...
                         <h4 class="card-title" style="text-align: center">Cost per day :<%=rs.getInt("cost")%> </h4>
                          ...
                          <a href="booking.jsp?id=<%=rs.getInt("id")%>" onclick="return confirm('You Need To Login First')" class="btn btn-success" style="text-align: center"><h4>Book Now</h4></a>
